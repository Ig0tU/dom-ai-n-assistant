...
// @grant        GM_openInTab
// @connect      127.0.0.1
// @connect      https://kswz64-5000.csb.app/
// @connect      localhost
...
(function() {
    ...
    class PerformanceMonitor {
        ...
        async getReport() {
            ...
            const perf = unsafeWindow.performance.timing;
            return {
                pageLoadTime: perf.loadEventEnd - perf.navigationStart,
                domInteractive: perf.domInteractive - perf.navigationStart,
                networkRequests: unsafeWindow.performance.getEntriesByType ? unsafeWindow.performance.getEntriesByType('resource').length : 'N/A',
            };
        }
    }
                ...
                send(body) {
                    if (body) {
                        try {
                            ...
                            this._requestBody = body; // Not JSON
                        }
                    }
                    ...
                    if (matchedRule) {
                        ...
                        const responseBody = matchedRule.response;
                        // Simulate XHR response
                        Object.defineProperty(this, 'status', { value: matchedRule.status, writable: true });
                        Object.defineProperty(this, 'responseText', { value: responseBody, writable: true });
                        Object.defineProperty(this, 'response', { value: JSON.parse(responseBody), writable: true }); // For .response property
    ...
    class VulnerabilityScanner {
        ...
        async scanXSS(targetElement = null) {
            ...
            unsafeWindow.console.log = originalConsoleLog; // Restore original console.log
